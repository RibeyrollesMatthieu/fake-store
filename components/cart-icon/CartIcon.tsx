        ...
        <Link href='/cart' passHref={true}>
          <CartWrapper>
            ...
            <Svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <text fill="black" xmlSpace="preserve" style={{whiteSpace: 'pre', textAlign: 'center'}} fontFamily="Roboto" fontSize="10" letterSpacing="0em"><tspan x="8" y="13.418">{ (cart.quantity > 99) ? '99+' : (cart.quantity < 10) ? `  ${cart.quantity}` : ` ${cart.quantity}` }</tspan></text>
            </Svg>
          </CartWrapper>
        </Link>
      </>
